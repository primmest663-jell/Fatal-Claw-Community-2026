...
# 🎮 Fatal Claw — Community Edition

**Standalone Community Edition of the fast-paced 2D action roguelite.**
...
Fatal Claw is a fast-paced 2D side-scrolling action roguelite built around precise claw combat, dash-heavy movement, and demanding boss encounters. This Community Edition is a standalone, self-contained package of the full game, prepared as an independent release for offline play. No storefront account, launcher, or additional software is required, and all content is included in the package.

Players who want a self-contained, offline Community Edition of Fatal Claw that runs on Windows without any storefront or additional software.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2827750/2574d5be57a538087ce1da953439152c19f0aebd/ss_2574d5be57a538087ce1da953439152c19f0aebd.1920x1080.jpg?t=1788415593" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2827750/aeb4ea72736eac74c0af6418e57faae6aaf39aeb/ss_aeb4ea72736eac74c0af6418e57faae6aaf39aeb.1920x1080.jpg?t=1788415593" alt="Screenshot 2" width="100%"></td>
...
- 🗡️ **Claw Combat** — Combo-driven melee system built around fast claw strikes and chained attacks.
- 💨 **Dash Movement** — Responsive dashing and dodging mechanics central to both traversal and combat.
- 👹 **Challenging Bosses** — Multi-phase boss encounters with distinct attack patterns and tactics.
- 🔁 **Roguelite Progression** — Run-based structure with persistent upgrades across attempts.
- 🎨 **Pixel-Art Visuals** — Detailed handcrafted pixel-art environments, characters, and animations.
- 🗺️ **Varied Stages** — Distinct zones with unique hazards, enemies, and environmental challenges.
- 📈 **Unlockable Content** — All in-game unlockables, upgrades, and modes included in this build.
- 🎮 **Controller Support** — Full gamepad support alongside keyboard controls.
- 📦 **Self-Contained Package** — Offline version with everything needed to run the game in one download.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~5 minutes on HDD
- **Recoding:** none
- **Selective Download:** none — full package included
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD Graphics 4000 / integrated GPU with DirectX 11 support | NVIDIA GeForce GTX 1050 / AMD Radeon RX 560 or better |
| **Storage** | 2 GB available space | 2 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card, keyboard or controller | Gamepad controller recommended |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\FatalClaw\Saved`
